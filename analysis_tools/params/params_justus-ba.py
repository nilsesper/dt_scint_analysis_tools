...
_oc_difference_for_overflow = 20000 # difference between oc and last oc for oc overflow to be triggered
...
### hardware setup
## ro_ch list
_obdt_theta_ro_ch = 2*(13)
_obdt_phi_1_ro_ch = 2*( 7)
_obdt_phi_2_ro_ch = 2*(14)
## dt mapping: {ro_ch: obdt_mapping}
_dt_mapping = {
    _obdt_phi_1_ro_ch: _obdt_phi_1_fe_mapping, # obdt1_phi: dt sl1 (phi)
    _obdt_phi_2_ro_ch: _obdt_phi_2_fe_mapping, # obdt2_phi: dt sl3 (phi)
    _obdt_theta_ro_ch: _obdt_theta_1_fe_mapping, # obdt3_theta: dt sl2 (theta)
}
