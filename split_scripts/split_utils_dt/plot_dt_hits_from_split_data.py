...
def main():
    ...
    ## store plot
    if args.store_path:
        hist_plot_file = args.store_path+"/"+common_file_prefix+"_"+dataset+"_SPECIFIC_"+"RATE"+".png"
        print(f"store plot as {hist_plot_file}.")
        fig.savefig(hist_plot_file)
    ...
    for sl in range(1,4):
        ...
        ## store plot
        if args.store_path:
            hist_plot_file = args.store_path+"/"+common_file_prefix+"_"+dataset+"_SPECIFIC_"+f"SL{sl}_RATE"+".png"
            print(f"store plot as {hist_plot_file}.")
            fig.savefig(hist_plot_file)
