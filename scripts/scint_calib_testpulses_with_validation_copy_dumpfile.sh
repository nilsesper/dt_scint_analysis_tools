...
# do analysis
python scripts/scint_calib_testpulses.py --inputfile ~/masterarbeit/zynq_read-out_software/output/${args[0]}.txt --validationfile ~/masterarbeit/zynq_read-out_software/output/${args[0]}_validation.txt
